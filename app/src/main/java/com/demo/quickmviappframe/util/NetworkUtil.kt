...
object NetworkUtil {
    ...
    const val GET_TOKEN: Int = 1
    const val CHECK_TOKEN: Int = 2
    const val REFRESH_TOKEN: Int = 3
    const val GET_INFO: Int = 4
    const val GET_IMG: Int = 5
    ...
    internal class HttpsThread(private val handler: Handler, private val httpsUrl: String?, private val msgTag: Int) : Thread() {
        override fun run() {
            if (msgTag == GET_IMG) {
                try {
